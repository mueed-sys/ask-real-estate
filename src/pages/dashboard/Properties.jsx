              ...
              {filtered.map((p) => {
                ...
                return (
                  <tr key={p.id} className="border-b border-white/5 transition-colors hover:bg-white/[0.02]">
                    ...
                    <td className="px-5 py-3">
                      <span className="font-numbers text-sm tracking-wider text-gold-400">{p.id}</span>
                    </td>
                    ...
                    <td className="px-5 py-3">
                      <span className="font-numbers text-base tracking-wider text-gold-300">BD {formatPrice(p.price)}</span>
                    </td>
                    <td className="px-5 py-3"><StatusBadge status={p.status} /></td>
                    <td className="px-5 py-3 font-numbers text-base tracking-wider text-ink-200">{p.views}</td>
                    <td className="px-5 py-3 font-numbers text-base tracking-wider text-emerald-400">{p.inquiries}</td>
