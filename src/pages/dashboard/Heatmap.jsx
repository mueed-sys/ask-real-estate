            ...
            <ul className="divide-y divide-white/5">
              {ranked.map((a, i) => (
                <li key={a.slug}>
                  ...
                  >
                    <span className="font-numbers text-lg font-bold tracking-tight tabular-nums text-gold-500 w-6 text-center">{String(i + 1).padStart(2, '0')}</span>
                    ...
                    <span className="font-numbers text-sm font-bold tracking-tight tabular-nums text-gold-300">{a[metric].toLocaleString()}</span>
                  </button>
                </li>
              ))}
            </ul>
...
function Stat({ label, value }) {
  return (
    <div className="rounded border border-white/5 bg-white/[0.02] py-2">
      <p className="font-numbers text-lg font-bold tracking-tight tabular-nums text-gold-300">{value}</p>
