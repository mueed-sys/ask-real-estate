              ...
              <li key={p.id}>
                ...
                >
                  ...
                  <div className="text-right">
                    <p className="font-numbers text-lg font-bold tracking-tight tabular-nums text-gold-300">{p.views.toLocaleString()}</p>
                    <p className="text-[10px] uppercase tracking-widest text-ink-400">views</p>
                  </div>
                  <div className="hidden text-right sm:block">
                    <p className="font-numbers text-base font-bold tracking-tight tabular-nums text-emerald-400">{Math.round((p.views / 30) * 0.12)}%</p>
