              ...
              {result && (
                ...
                >
                  <div className="text-center">
                    ...
                    <p className="mt-2 font-numbers text-6xl font-bold tracking-tight tabular-nums text-gold-gradient">
              ...
              <ul className="divide-y divide-white/5">
                {result.factors.map((f, i) => (
                  <li key={i} className="flex items-center justify-between px-5 py-3">
                    ...
                    <span className={`font-numbers text-sm font-bold tracking-tight tabular-nums ${f.delta > 0 ? 'text-emerald-400' : 'text-red-400'}`}>
